...
const SEEDS: Seed[] = [
  {
    ...
    why: 'Storm disruptions affect commutes, ferries, flights and deliveries across the region. The practical impact lands within hours, not days.',
  ...
  },
  {
    ...
    why: 'Adaptation financing determines how prepared vulnerable regions are for floods, drought and heat, and it shapes migration and food prices globally.',
